    ...
    <div class="container" >
            ...
            <div class="col-md-8">
               ...
               <form onsubmit="sendMessage()" autocomplete="off">
                ...
                <div class="row">
                    <h5>Kelas</h5>
                    <div class="row">
                        <input id="kelas" type="text" placeholder="Masukkan Kelas" class="form-control rounded" req>
                    </div>
                </div>
                <div class="row d-flex justify-content-end">
                    <button style="background-color: #B72024; color: white; border: none; padding: 1%; width: 70px; border-radius: 10%;"  >Kirim</button>
                </div>
               </form>
            </div>
        </div>
     ...
     <script>
      function sendMessage() {
        ...
        const url =
          "https://api.whatsapp.com/send?phone=+6281212527602&text=Permisi%20kak%0ASaya%20"+nama+"%20dari%20Kelas%20"+kelas+"%20Keluhan%20saya%20adalah%20"+keluhan+"%0A%0ATerima%20Kasih%20Kak";
